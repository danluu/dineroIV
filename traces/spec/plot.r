...
setwd("/Users/danluu/dev/dineroIV/traces/spec")

# color scheme used below is from http://colorbrewer2.org/
# "qualatative", red blue green purple...

png(filename="sandy-bridge-miss.png",width=640,height=480)
...
png(filename="sweep-sizes-miss.png",width=640,height=480)
...
png(filename="sweep-sizes-miss-l3.png",width=640,height=480)
...
png(filename="sweep-sizes-mean-ratios.png",width=640,height=480)
...
png(filename="sweep-sizes-mean-ratios-l3.png",width=640,height=480)
...
png(filename="sweep-sizes-mean-ratios-l3-pseudo.png",width=640,height=480)
# Ratio of means (multi-level cache)
...
png(filename="sweep-sizes-assocs-mean-ratios.png",width=640,height=480)
...
scale_x_continuous(name="Cache size", breaks=16:24, labels=c("64k","128k","256k","512k","1M","2M","4M","8M","16M")) +
scale_y_continuous(name="Cache associativity", trans="log2", breaks=c(4,8,16,32,64), labels=c(4,8,16,32,64))
